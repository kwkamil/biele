...
export default function Edit({ gallery, users }: EditProps) {
    const { data, setData, put, processing, errors } = useForm({
        user_id: gallery.user_id.toString(),
        name: gallery.name || '',
        description: gallery.description || '',
        is_approved: gallery.is_approved || false,
    ...
    return (
        <AdminLayout>
            <Head title={`Edit ${gallery.name} - Admin`} />

            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Gallery</h1>
