...
export default function Show({ inquiry, artworks }: ShowProps) {
    ...
    return (
        <AdminLayout>
            <Head title={`Inquiry from ${inquiry.first_name} ${inquiry.last_name} - Admin`} />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            View inquiry information and status
                        </p>
                    </div>
                        ...
                        <div className="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <span className={`mt-1 inline-block rounded-full px-3 py-1 text-sm font-medium ${getStatusBadge(inquiry.status)}`}>
